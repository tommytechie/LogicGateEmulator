...
int main() {
	...
	obj11.assignFunctions(0);
	obj12.assignFunctions(1);
	obj13.assignFunctions(2);
	obj14.assignFunctions(3);
	obj15.assignFunctions(0);
	obj16.assignFunctions(1);
	obj17.assignFunctions(2);
	obj18.assignFunctions(3);
